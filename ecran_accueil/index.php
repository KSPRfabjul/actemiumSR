...
if($select->rowCount() == 0){
	$select = $db->query("SELECT * FROM accueil WHERE id=1");
}
...
<body>
	...
	<div class="row content">
		...
		<!-- main -->
		<div class="col-lg-offset-1 col-lg-7" id="main">
			
			<!-- row -->
			<div class="row main-A">
				<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="meteo">
						...
						style="width:400px;height:250px;display: block;text-indent: -50000px;font-size: 0px;background:#DDF url(http://yowindow.com/img/logo.png) no-repeat scroll 50% 50%;">Widget météo</a>
						</object>
					</div>
				</div>
			</div>
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<?php
								...
								//on trie le tableau par ordre alphabétique
								array_multisort($tab_image_secu, SORT_ASC);

								//affichage de la première image
								$image = '<img class="center-block img-carousel img-secu" src="'.$nom_repertoire.'/'.$tab_image_secu[0].'" alt="">';
								...
								//affichage des images
								for ($j=1;$j<=$i-1;$j++){
									$image = '<img class="center-block img-carousel img-secu" src="'.$nom_repertoire.'/'.$tab_image_secu[$j].'" alt="">';
	...
	<div class="accident">
		<div style="display:inline-block; vertical-align:top;"><ul id="countdown-visits"></ul>
		<script type="text/javascript" src="./js/countdown-visit.js"></script></div>
		<div style="display:inline-block; vertical-align:top;"><h2> jours sans accidents</h2></div>
	</div>

	<div class="heure" style="text-align:center;width:350px;padding:0.5em 0;">
